...
{
	//private SensorInfoHandler pushServiceHandler;
...
//	private final int SEND_PUSHSERVICE_VALUE_TEMPERATURE = 2;
	...
	private static final String		MQTT_HOST = "192.168.0.7";
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public void MessageToString(String topicName, String message)
		{
			if(topicName.equals("hoyong/sensor/illu"))
			{
				...
				log("illu message: " + msg_illu);
			}
			else if(topicName.equals("hoyong/sensor/humi"))
			{
				msg_humi = new String(message+"%");
				log("humi message: " + msg_humi);
			}
			else//hoyong/sensor/temp
			{
				msg_temp = new String(message+"℃");
				log("temp message: " + msg_temp);
			}
		}
